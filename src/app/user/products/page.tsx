      ...
      <div className="relative overflow-hidden p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-800 shadow-lg shadow-indigo-500/10 border border-indigo-500/20">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <p className="text-[9px] sm:text-[10px] font-bold text-indigo-200 uppercase tracking-widest mb-0.5">Inventory</p>
              <h1 className="text-lg sm:text-2xl font-extrabold text-white tracking-tight leading-tight">Manage Products</h1>
              <p className="text-[10px] sm:text-xs font-semibold text-indigo-200/80 mt-0.5">Create, update, boost, and review your shop products catalog</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button asChild className="bg-white text-indigo-700 hover:bg-white/90 rounded-xl h-9 sm:h-10 shadow-md font-bold transition-all text-xs sm:text-sm">
